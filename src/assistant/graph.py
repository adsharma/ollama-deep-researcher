...
def generate_query(state: SummaryState, config: RunnableConfig):
    ...
    client = OpenAI(
        base_url=configurable.openai_base_url, api_key=configurable.openai_api_key
    )
...
def reflect_on_summary(state: SummaryState, config: RunnableConfig):
    ...
    result = llm_json_mode.invoke(
        [
            ...
            HumanMessage(
                content=f"""Identify a knowledge gap and generate a follow-up web search query based on our existing knowledge:
